...
function OptionsBar(props) {
    ...
    const { loading, error, data } = useQuery(GET_PRODUCTS_SEARCH_OPTIONS, {
        variables: {
            ...
            typeOrganic: props.fTypeOrganic ? true : null,
            typeKosher: props.fTypeKosher ? true : null,
            typeUSASourced: props.fTypeUSASourced ? true : null,
            typeColdProcessed: props.fTypeColdProcessed ? true : null,
            typeNonGMO: props.ftypeNonGMO ? true : null,
            typeWildcrafted: props.ftypeWildcrafted ? true : null,
            typeVirgin: props.ftypeVirgin ? true : null,
            typeRefinedAndRBD: props.ftypeRefinedAndRBD ? true : null,

            useHair: props.fuseHair ? true : null,
            useFace: props.fuseFace ? true : null,
            useBody: props.fuseBody ? true : null,
            useSoap: props.fuseSoap ? true : null,
            useCandles: props.fuseCandles ? true : null,
            useLip: props.fuseLip ? true : null,
            useBath: props.fuseBath ? true : null,
