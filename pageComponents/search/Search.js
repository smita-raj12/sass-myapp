...
function Search(props) {
    ...
    let ListProducts = (
        <Col sm={12} className='border border-primary my-2' style={{ height: "120px" }}>Loading ...</Col>
    )
    ...
    const OptionsBarHolder = (
        <OptionsBar
            ...
            handlefCategories={handlefCategories}
            ...
            <Container>
                <Row>
                    <Col xs={12} className="d-flex justify-content-center">
                        <Title as={'h1'} Size={"display-3"} Name={"Product Search"} />
                    </Col>
